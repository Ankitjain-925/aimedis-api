...
const welcome_message_therapist_en = `With Aimedis you are always at your patients’ side and in direct connection to doctors and the Aimedis support team.<br><br>
...
const welcome_message_therapist_de = `Mit Aimedis sind Sie immer an der Seite Ihrer Patienten und in direkter Verbindung zu Ärzten und dem Aimedis-Support-Team.<br><br>
...
const welcome_message_therapist_nl = `Met Aimedis staat u altijd aan de zijde van uw patiënten en staat u in directe verbinding met artsen en het ondersteuningsteam van Aimedis.<br><br>
...
const welcome_message_therapist_rs = `Благодаря Aimedis, вы всегда можете быть на стороне ваших пациентов, общаясь с врачами и службой поддержки Aimedis.<br><br>
...
const welcome_message_therapist_ch = `通过Aimedis，您始终站在患者身边，并与医生和Aimedis支持团队建立间接联系。<br><br>
验证您的帐户 - <b><a href="{0}" style="color:black;"> Here</a></b><br/><br/>
通过输入PIN和ID访问患者的记录，添加重要信息和数据或在必要时访问他们的紧急记录。<br><br>
如果您在注册时上传了许可证，您的帐户将在24小时内解锁。 如果没有，请将其发送到${licenseLink}。<br><br>
如果您有任何疑问，可以通过系统内的Aimedis支持聊天或通过电子邮件与我们联系${emailLink}。`;

const welcome_message_therapist_sw = `Ukiwa na Aimedis wewe huwa upande wa wagonjwa wako na kwa uhusiano wa moja kwa moja na madaktari na timu ya msaada ya Aimedis.<br><br>
...
Akaunti yako itafunguliwa kwa masaa 24, ikiwa umepakia leseni yako na usajili wako. Ikiwa sivyo tafadhali tuma kwa ${licenseLink}.<br><br>
...
const welcome_message_therapist_sp = `Con Aimedis, siempre estará al lado de sus pacientes y en conexión directa con los médicos y el equipo de soporte de Aimedis.<br><br>
...
Su cuenta se desbloqueará dentro de 24 horas, si ha cargado su licencia con su registro. Si no, por favor envíelo a ${licenseLink}.<br><br>
...
const welcome_message_therapist_pt = `Com a Aimedis, está sempre ao lado de seus pacientes e em contato direto com os médicos e a equipe de suporte da Aimedis.<br><br>
...
const welcome_message_therapist_fr = `Avec Aimedis, vous êtes toujours aux côtés de vos patients et en lien direct avec les médecins et l’équipe d’assistance Aimedis.<br><br>
Vérifiez votre compte - <b><a href="{0}" style="color:black;"> Here</a></b><br/><br/>
Accédez aux dossiers des patients en saisissant le code PIN et l'ID, ajoutez des informations et des données vitales ou accédez à leurs dossiers d'urgence au cas où cela serait nécessaire.<br><br>
...
const welcome_message_therapist_ar = `مع Aimedis ، تستطيع دوما أن  تكون دائمًا بجانب مرضاك وأيضا الاتصال المباشر بالأطباء و فريق دعم Aimedis<br><br>
تحقق من حسابك - <b><a href="{0}" style="color:black;"> Here</a></b><br/><br/>
تستطيع الوصول إلى سجلات المرضى عن طريق إدخال رقم التعريف الشخصي والمعرف ، وإضافة المعلومات والبيانات الحيوية و أيضا الوصول إلى سجلات الطوارئ الخاصة بهم في حالة الضرورة.
...
module.exports = {
  ...
  welcome_message_therapist_nl,
  welcome_message_therapist_rs,
  welcome_message_therapist_ch,
  welcome_message_therapist_sw,
  welcome_message_therapist_sp,
