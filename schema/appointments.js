...
appointmentsSchema.plugin(mongooseFieldEncryption, {
    fields: ["appointment_type", "patient", "doctor_id", "insurance", "annotations"], secret: process.env.SOME_32BYTE_BASE64_STRING,
    saltGenerator: function (secret) {
        return "1234567890123456"; // should ideally use the secret to return a string of length 16
    }
});
